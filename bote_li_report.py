...
# ===================== 仅改这2处 =====================
WECOM_WEBHOOK = "https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=518b8e62-4905-42ce-8fdb-67defa204693"  # 替换成你的
GEMINI_API_KEY = "AIzaSyBcOy9657OGhurUifdS45fzcDPv9-TcSpg"      # 替换成你的
# =====================================================
